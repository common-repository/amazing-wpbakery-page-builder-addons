<?php
/*
Plugin Name: Amazing WPBakery Page Builder Addons
Plugin URI: https://codenpy.com/
Description: Bundled with super useful WPBakery elements with bunch of options to achieve any design with all the power of WPBakery page builder for free.
Author: Noor-E-Alam
...
add_action( 'admin_init', 'asvc_required_plugin' );
    ...
    function asvc_required_plugin_notice(){
        ?><div class="error"><p>Error! you need to install or activate the <a target="_blank" href="https://codecanyon.net/item/visual-composer-page-builder-for-wordpress/242431?ref=themebonwp">WPBakery Page Builder for WordPress</a> plugin to run "<span style="font-weight: bold;">Amazing WPBakery Page Builder Addons</span>" plugin.</p></div><?php
    }
}
?>