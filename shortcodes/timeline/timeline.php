...
add_action( 'vc_before_init', 'asvc_timeline_init' );
function asvc_timeline_init() {
vc_map( array(
        "name" => __("Timeline", 'asvc'),
        "base" => "timeline",
        "icon" => "asvc_timeline_icon",
        "as_parent" => array('only' => 'timeline_item, timeline_sep'),
    	"category" =>array( __('Amazing Addons', 'asvc'),__('Content', 'asvc')),
...
add_action( 'vc_before_init', 'asvc_timeline_item_init' );
function asvc_timeline_item_init() {
vc_map( array(
...
add_action( 'vc_before_init', 'timeline_sep_init' );
function timeline_sep_init() {
vc_map( array(
